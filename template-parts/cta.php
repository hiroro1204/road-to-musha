	...
	<div class="l-container-s">
		<div class="c-cta-inner">
			<div class="c-cta-screenshot">
				<img src="<?php echo esc_url( get_template_directory_uri() . '/img/img-cta-screenshot.png' ); ?>"
					width="640" height="362" alt="模写修行のPC画面のスクリーンショット" />
			</div>

			<div class="c-cta-body">
				<div class="c-cta-logo">
					<img src="<?php echo esc_url( get_template_directory_uri() . '/img/logo-moshashugyo.png' ); ?>"
